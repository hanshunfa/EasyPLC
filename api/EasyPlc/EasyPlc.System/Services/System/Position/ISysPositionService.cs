...
public interface ISysPositionService : ITransient
{
    ...
    /// <returns></returns>
    Task Add(PositionAddInput input, string name = EasyPlcConst.SysPos);
    ...
    /// <param name="name">名称</param>
    /// <returns></returns>
    Task Delete(List<BaseIdInput> input, string name = EasyPlcConst.SysPos);
    ...
    /// <param name="name">名称</param>
    /// <returns></returns>
    Task Edit(PositionEditInput input, string name = EasyPlcConst.SysPos);
