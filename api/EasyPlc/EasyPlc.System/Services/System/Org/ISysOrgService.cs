...
public interface ISysOrgService : ITransient
{
    ...
    /// <returns></returns>
    Task Add(SysOrgAddInput input, string name = EasyPlcConst.SysOrg);
    ...
    /// <param name="name">名称</param>
    /// <returns></returns>
    Task Edit(SysOrgEditInput input, string name = EasyPlcConst.SysOrg);
    ...
    /// <param name="name">名称</param>
    /// <returns></returns>
    Task Delete(List<BaseIdInput> input, string name = EasyPlcConst.SysOrg);
