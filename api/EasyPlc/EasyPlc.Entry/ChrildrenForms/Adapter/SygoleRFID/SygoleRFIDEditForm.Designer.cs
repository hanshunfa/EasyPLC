...
partial class SygoleRFIDEditForm
{
    /// <summary>
    ...
    {
        ComponentResourceManager resources = new ComponentResourceManager(typeof(SygoleRFIDEditForm));
        ...
        // textEdit1
        // 
        textEdit1.Location = new Point(81, 12);
        textEdit1.Name = "textEdit1";
        textEdit1.Size = new Size(261, 20);
        ...
        textEdit2.Location = new Point(81, 36);
        ...
        textEdit2.Size = new Size(261, 20);
        textEdit2.StyleController = layoutControl1;
        textEdit2.TabIndex = 4;
        // 
        // spinEdit1
        // 
        spinEdit1.EditValue = new decimal(new int[] { 3001, 0, 0, 0 });
        spinEdit1.Location = new Point(81, 60);
        ...
        spinEdit1.Properties.MaxValue = new decimal(new int[] { 10000, 0, 0, 0 });
        spinEdit1.Properties.MinValue = new decimal(new int[] { 1000, 0, 0, 0 });
        spinEdit1.Size = new Size(261, 20);
        ...
        spinEdit2.Location = new Point(81, 84);
        ...
        spinEdit2.Properties.MaxValue = new decimal(new int[] { 99, 0, 0, 0 });
        spinEdit2.Size = new Size(261, 20);
        spinEdit2.StyleController = layoutControl1;
        spinEdit2.TabIndex = 6;
        // 
        // spinEdit3
        // 
        spinEdit3.EditValue = new decimal(new int[] { 99, 0, 0, 0 });
        spinEdit3.Location = new Point(81, 108);
        ...
        spinEdit3.Size = new Size(261, 20);
        ...
        Root.Items.AddRange(new DevExpress.XtraLayout.BaseLayoutItem[] { layoutControlItem2, emptySpaceItem3, emptySpaceItem1, layoutControlItem1, layoutControlItem3, layoutControlItem4, layoutControlItem5, layoutControlItem6, layoutControlItem7 });
        Root.Name = "Root";
        ...
        emptySpaceItem1.Size = new Size(334, 88);
        ...
        layoutControlItem3.TextSize = new Size(57, 14);
        // 
        // layoutControlItem4
        // 
        ...
        layoutControlItem4.TextSize = new Size(57, 14);
        // 
        // layoutControlItem5
        // 
        ...
        layoutControlItem5.TextSize = new Size(57, 14);
        // 
        // layoutControlItem6
        // 
        layoutControlItem6.Control = spinEdit2;
        layoutControlItem6.Location = new Point(0, 72);
        layoutControlItem6.Name = "layoutControlItem6";
        layoutControlItem6.Size = new Size(334, 24);
        layoutControlItem6.Text = "ReaderID*";
        layoutControlItem6.TextSize = new Size(57, 14);
        // 
        // layoutControlItem7
        // 
        ...
        layoutControlItem7.TextSize = new Size(57, 14);
        // 
        // SygoleRFIDEditForm
        // 
        ...
        MaximizeBox = false;
        MinimizeBox = false;
        Name = "SygoleRFIDEditForm";
        StartPosition = FormStartPosition.CenterParent;
        Text = "SygoleRFIDEditForm";
        Load += SygoleRFIDEditForm_Load;
