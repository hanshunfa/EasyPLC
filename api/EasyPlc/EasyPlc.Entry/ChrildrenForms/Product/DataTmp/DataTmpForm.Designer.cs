...
partial class DataTmpForm
{
    ...
    private void InitializeComponent()
    {
        ...
        ComponentResourceManager resources = new ComponentResourceManager(typeof(DataTmpForm));
        ...
        tileViewColumn9 = new DevExpress.XtraGrid.Columns.TileViewColumn();
        ...
        // tileViewColumn9
        // 
        tileViewColumn9.Caption = "ID";
        tileViewColumn9.FieldName = "Id";
        tileViewColumn9.Name = "tileViewColumn9";
        tileViewColumn9.Visible = true;
        tileViewColumn9.VisibleIndex = 8;
        // 
        // tileViewColumn2
        // 
        tileViewColumn2.Caption = "工单ID";
        tileViewColumn2.FieldName = "OrderId";
        ...
        // tileViewColumn3
        // 
        tileViewColumn3.Caption = "加工流程ID";
        tileViewColumn3.FieldName = "WorkingStepId";
        ...
        // tileViewColumn7
        // 
        tileViewColumn7.Caption = "开始时间";
        tileViewColumn7.DisplayFormat.FormatString = "G";
        tileViewColumn7.DisplayFormat.FormatType = DevExpress.Utils.FormatType.DateTime;
        tileViewColumn7.FieldName = "CreateTime";
        tileViewColumn7.Name = "tileViewColumn7";
        tileViewColumn7.Visible = true;
        tileViewColumn7.VisibleIndex = 6;
        // 
        // tileViewColumn8
        // 
        tileViewColumn8.Caption = "跟新时间";
        tileViewColumn8.DisplayFormat.FormatString = "G";
        tileViewColumn8.DisplayFormat.FormatType = DevExpress.Utils.FormatType.DateTime;
        tileViewColumn8.FieldName = "UpdateTime";
        tileViewColumn8.Name = "tileViewColumn8";
        tileViewColumn8.Visible = true;
        tileViewColumn8.VisibleIndex = 7;
        // 
        // tileViewColumn5
        // 
        tileViewColumn5.Caption = "PCBSN";
        tileViewColumn5.FieldName = "PcbSN";
        ...
        // tileViewColumn4
        // 
        tileViewColumn4.Caption = "线束SN";
        tileViewColumn4.FieldName = "CableSN";
        ...
        // tileViewColumn1
        // 
        tileViewColumn1.Caption = "产品状态";
        tileViewColumn1.FieldName = "ProductStatus";
        ...
        // tileViewColumn6
        // 
        tileViewColumn6.Caption = "镭射SN";
        tileViewColumn6.FieldName = "LaserSN";
        ...
        ribbonControl1.Items.AddRange(new DevExpress.XtraBars.BarItem[] { ribbonControl1.ExpandCollapseItem, ribbonControl1.SearchEditItem, barButtonItem2, barButtonItem3, barButtonItem4, barButtonItem1, barButtonItem5, barButtonItem6 });
        ribbonControl1.Location = new Point(0, 0);
        ribbonControl1.MaxItemId = 8;
        ribbonControl1.Name = "ribbonControl1";
        ribbonControl1.Pages.AddRange(new DevExpress.XtraBars.Ribbon.RibbonPage[] { ribbonPage1 });
        ribbonControl1.Size = new Size(906, 170);
        // 
        // barButtonItem2
        // 
        ...
        tablePanel1.Rows.AddRange(new DevExpress.Utils.Layout.TablePanelRow[] { new DevExpress.Utils.Layout.TablePanelRow(DevExpress.Utils.Layout.TablePanelEntityStyle.AutoSize, 26F), new DevExpress.Utils.Layout.TablePanelRow(DevExpress.Utils.Layout.TablePanelEntityStyle.Relative, 26F), new DevExpress.Utils.Layout.TablePanelRow(DevExpress.Utils.Layout.TablePanelEntityStyle.AutoSize, 26F) });
        tablePanel1.Size = new Size(906, 434);
        tablePanel1.TabIndex = 3;
        // 
        // paginationControl1
        // 
        tablePanel1.SetColumn(paginationControl1, 0);
        paginationControl1.Location = new Point(3, 405);
        paginationControl1.Name = "paginationControl1";
        tablePanel1.SetRow(paginationControl1, 2);
        paginationControl1.Size = new Size(900, 26);
        ...
        gridControl1.Location = new Point(3, 38);
        gridControl1.MainView = tileView1;
        gridControl1.MenuManager = ribbonControl1;
        gridControl1.Name = "gridControl1";
        tablePanel1.SetRow(gridControl1, 1);
        gridControl1.Size = new Size(900, 361);
        gridControl1.TabIndex = 1;
        gridControl1.ViewCollection.AddRange(new DevExpress.XtraGrid.Views.Base.BaseView[] { tileView1 });
        // 
        // tileView1
        // 
        tileView1.Columns.AddRange(new DevExpress.XtraGrid.Columns.GridColumn[] { tileViewColumn1, tileViewColumn2, tileViewColumn3, tileViewColumn4, tileViewColumn5, tileViewColumn6, tileViewColumn7, tileViewColumn8, tileViewColumn9 });
        tileView1.GridControl = gridControl1;
        tileView1.Name = "tileView1";
        tileView1.OptionsTiles.IndentBetweenGroups = 64;
        tileView1.OptionsTiles.ItemSize = new Size(438, 80);
        ...
        tableColumnDefinition1.Length.Value = 64D;
        tableColumnDefinition2.Length.Value = 116D;
        tableColumnDefinition3.Length.Value = 61D;
        tableColumnDefinition4.Length.Value = 129D;
        tableColumnDefinition5.Length.Value = 16D;
        ...
        tileViewItemElement1.Column = tileViewColumn9;
        tileViewItemElement1.ColumnIndex = 1;
        tileViewItemElement1.ImageOptions.ImageAlignment = DevExpress.XtraEditors.TileItemContentAlignment.MiddleCenter;
        tileViewItemElement1.ImageOptions.ImageScaleMode = DevExpress.XtraEditors.TileItemImageScaleMode.Squeeze;
        tileViewItemElement1.Text = "tileViewColumn9";
        ...
        tileViewItemElement5.Text = "tileViewColumn8";
        tileViewItemElement5.TextAlignment = DevExpress.XtraEditors.TileItemContentAlignment.MiddleLeft;
        tileViewItemElement6.Appearance.Normal.Font = new Font("Tahoma", 9F, FontStyle.Bold, GraphicsUnit.Point);
        tileViewItemElement6.Appearance.Normal.Options.UseFont = true;
        tileViewItemElement6.Column = tileViewColumn5;
        ...
        tileViewItemElement7.Appearance.Normal.Font = new Font("Tahoma", 9F, FontStyle.Bold, GraphicsUnit.Point);
        tileViewItemElement7.Appearance.Normal.Options.UseFont = true;
        tileViewItemElement7.Column = tileViewColumn4;
        ...
        tileViewItemElement9.Text = "工单ID:";
        ...
        tileViewItemElement10.Text = "PCBSN:";
        ...
        tileViewItemElement11.Text = "开始时间:";
        ...
        tileViewItemElement12.Text = "流程ID:";
        ...
        tileViewItemElement13.Text = "线束SN:";
        ...
        tileViewItemElement14.Text = "更新时间:";
        tileViewItemElement14.TextAlignment = DevExpress.XtraEditors.TileItemContentAlignment.MiddleLeft;
        tileViewItemElement15.Appearance.Normal.BackColor = Color.Blue;
        tileViewItemElement15.Appearance.Normal.Options.UseBackColor = true;
        tileViewItemElement15.Column = tileViewColumn1;
        tileViewItemElement15.ColumnIndex = 4;
        ...
        tileViewItemElement15.ImageVisible = false;
        tileViewItemElement15.StretchVertical = true;
        tileViewItemElement15.Text = "tileViewColumn1";
        ...
        tileViewItemElement16.Text = "镭射SN:";
        tileViewItemElement16.TextAlignment = DevExpress.XtraEditors.TileItemContentAlignment.MiddleLeft;
        tileViewItemElement17.Appearance.Normal.Font = new Font("Tahoma", 9F, FontStyle.Bold, GraphicsUnit.Point);
        tileViewItemElement17.Appearance.Normal.Options.UseFont = true;
        tileViewItemElement17.Column = tileViewColumn6;
        ...
        tileViewItemElement17.Text = "tileViewColumn6";
        ...
        tablePanel1.SetRow(stackPanel1, 0);
        stackPanel1.Size = new Size(900, 29);
        ...
        labelControl1.Size = new Size(84, 14);
        labelControl1.TabIndex = 0;
        labelControl1.Text = "请选择订单号：";
        // 
        // comboBoxEdit1
        // 
        comboBoxEdit1.Location = new Point(93, 4);
        comboBoxEdit1.MenuManager = ribbonControl1;
        comboBoxEdit1.Name = "comboBoxEdit1";
        comboBoxEdit1.Properties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] { new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo) });
        comboBoxEdit1.Properties.TextEditStyle = DevExpress.XtraEditors.Controls.TextEditStyles.DisableTextEditor;
        comboBoxEdit1.Size = new Size(384, 20);
        ...
        simpleButton1.Location = new Point(483, 3);
        simpleButton1.Name = "simpleButton1";
        simpleButton1.Size = new Size(126, 23);
        simpleButton1.TabIndex = 2;
        simpleButton1.Text = "当前正在生产工单";
        simpleButton1.Click += simpleButton1_Click;
        // 
        // labelControl2
        // 
        labelControl2.Location = new Point(615, 7);
        labelControl2.Name = "labelControl2";
        labelControl2.Size = new Size(96, 14);
        labelControl2.TabIndex = 3;
        labelControl2.Text = "请输入产品编码：";
        // 
        // textEdit1
        // 
        textEdit1.Location = new Point(717, 4);
