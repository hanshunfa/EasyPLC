...
partial class PreviewLabelForm
{
    /// <summary>
    ...
    {
        ComponentResourceManager resources = new ComponentResourceManager(typeof(PreviewLabelForm));
        ...
        simpleButton1.Text = "发送当前打标内容，触发打标";
        ...
        layoutControlGroup1.Text = "标签详情预览";
        // 
        // layoutControlItem2
        // 
        ...
        Name = "PreviewLabelForm";
        Text = "标签预览";
        Load += PreviewLabelForm_Load;
