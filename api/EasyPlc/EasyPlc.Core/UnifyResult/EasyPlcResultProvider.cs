...
/// 规范化RESTful风格返回值
/// </summary>
[SuppressSniffer, UnifyModel(typeof(EasyPlcResult<>))]
public class EasyPlcResultProvider : IUnifyResultProvider
{
    /// <summary>
    /// 异常返回
    /// </summary>
    ...
    /// <returns></returns>
    private static EasyPlcResult<object> RESTfulResult(int statusCode, bool succeeded = default,
        object data = default, object errors = default)
    {
        return new EasyPlcResult<object>
        {
            Code = statusCode,
