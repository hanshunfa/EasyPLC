...
public class OrgService : DbRepository<SysOrg>, IOrgService
{
    ...
    public async Task Add(SysOrgAddInput input)
    {
        ...
        await _sysOrgService.Add(input, EasyPlcConst.BizOrg);
    }
    ...
    public async Task Edit(SysOrgEditInput input)
    {
        ...
        await _sysOrgService.Edit(input, EasyPlcConst.BizOrg);
    }
    ...
    public async Task Delete(List<BaseIdInput> input)
    {
        ...
        await _sysOrgService.Delete(input, EasyPlcConst.BizOrg);//删除操作
    }
